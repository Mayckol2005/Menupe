...
while flag==True:
    ...
    try:
        ...
        total_descuento = sueldo_bruto_total*(afp+fonasa)
        descuentoAfp = sueldo_bruto_total*afp
        descuentoFonasa = sueldo_bruto_total*fonasa
        sueldo_liquido = sueldo_bruto_total-total_descuento
